<template>
	<div style='text-align: center;'>
		...
		<el-row>
		  ...
		  <el-col :span="12"> <el-date-picker v-model="devdate" type="date" placeholder="请选择投入日期" style='width:300px;margin-top: 20px;' value-format='yyyy-MM-dd'> </el-date-picker> </el-col>
		</el-row>
		<el-row>
