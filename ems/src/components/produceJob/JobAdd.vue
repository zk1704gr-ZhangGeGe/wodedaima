		...
		<el-row>
		  <el-col :span="12">
			  <el-date-picker
			    ...
			    type="datetime"
			    value-format="yyyy-MM-dd HH:mm:ss"
			    placeholder="请添加结束作业时间">
			  </el-date-picker>
		  </el-col>
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' placeholder='请添加运行时长' v-model='duration'></el-input> </el-col>
		</el-row>
		<el-row>
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' placeholder='请添加作业量' v-model='amount'></el-input> </el-col>
