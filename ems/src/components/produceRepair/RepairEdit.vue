<template>
	<div style='text-align: center;'>
		...
		<el-row>
		  ...
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' placeholder='请修改维修原因' v-model='cause'></el-input> </el-col>
		</el-row>
		<el-row>
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' placeholder='请修改费用' v-model='cost'></el-input> </el-col>
