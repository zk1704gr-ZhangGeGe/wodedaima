...
// 				flowid:'',
		...
		methods:{
			saveUpdate(){
				...
				// 传递给后端的数据
				var data = {reportid:this.completetime,shipname:this.shipname,capacity:this.capacity,planjobtime:this.planjobtime,reportuser:this.reportuser,compid:this.compid};
